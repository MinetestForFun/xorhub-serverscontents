...
cd /home/quentinbd/server-minetestforfun-skyblock/ || exit "Le répertoire cloné n'existe pas !"
git submodule sync
...
mkdir -p $PATH_SERVER/games/minetestforfun_skyblock/
mkdir -p $PATH_SERVER/games/minetestforfun_skyblock/mods/
