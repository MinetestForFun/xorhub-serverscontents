...
### Classic ###
    ...
    sleep 0.5
    screen -dmS "mff-classic" nice -n-10 /home/quentinbd/scripts/start-mff.sh
    sleep 0.5
### Hunger Games ###
    ...
    sleep 0.5
    screen -dmS "mff-hg" nice -n-10 /home/quentinbd/scripts/start-mff-hg.sh
    sleep 0.5
### SkyBlock ###
    ...
    sleep 0.5
    screen -dmS "mff-skyblock" nice -n-10 /home/quentinbd/scripts/start-mff-skyblock.sh
    sleep 0.5
### Creative ###
    ...
    sleep 0.5
    screen -dmS "mff-creative" nice -n-10 /home/quentinbd/scripts/start-mff-creative.sh
    sleep 0.5
